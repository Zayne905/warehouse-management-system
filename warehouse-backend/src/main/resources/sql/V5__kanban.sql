...
CREATE TABLE IF NOT EXISTS kanban (
    ...
    outbound_order_id   BIGINT       DEFAULT NULL COMMENT '锁定出库单ID(待出库时填充)',
    outbound_order_no   VARCHAR(20)  DEFAULT NULL COMMENT '出库单号(冗余)',
    ...
    status              TINYINT      DEFAULT 0 COMMENT '状态: 0=待入库 1=在库可用 2=待出库(锁定) 3=已出库 4=封存',
